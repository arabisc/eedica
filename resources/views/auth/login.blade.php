...
{{-- <div class="uk-container uk-flex uk-flex-center uk-margin">
		...
		<form class="uk-form-stacked" method="POST" action="{{ route('login') }}" novalidate>
			...
			<div class="uk-card-body">
				<div class="uk-margin">
					...
					<div class="uk-width-1-1 uk-inline">
						<span
							class="uk-form-icon uk-form-icon uk-text-primary uk-background-muted ee-border
							{{ $errors->has('email') ? ' ee-border-red uk-text-danger' : '' }}"
							uk-icon="icon: user">
						</span>
				...
				<div class="uk-margin">
					...
					<div class="uk-width-1-1 uk-inline">
						<span class="uk-form-icon uk-form-icon uk-text-primary uk-background-muted ee-border
						{{ $errors->has('email') ? ' ee-border-red uk-text-danger' : '' }}"
						 uk-icon="icon: lock">
						</span>
						<input id="password" type="password" class="uk-input {{ $errors->has('password') ? ' ee-border-red' : '' }}"
