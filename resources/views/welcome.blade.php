...
@section('content')
  @include('client/courses/sections/title')
  @include('client/courses/sections/loginSection')
  @include('client/courses/sections/registerButton')
  @include('client/courses/sections/services')
  @include('client/courses/sections/courses')
  @include('client/courses/sections/toTop')
@endsection
