...
<div class="uk-container uk-margin-medium uk-margin-medium-bottom" id="createUser">
    ...
    <form action="{{ route('users.store') }}" class="uk-padding" method="POST">
      ...
      <fieldset class="uk-fieldset">
        ...
        <div class="uk-margin">
          ...
          <div class="uk-width-1-1 uk-inline">
            ...
            <input
              id="password"
              type="password"
              class="uk-input uk-border-rounded uk-margin-small-left
        ...
        <div class="uk-margin-medium-top">
          <label for="roles" class="uk-form-label uk-text-warning uk-margin-small">
