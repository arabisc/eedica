...
Route::get('/','WelcomeController@clientCourses');
Route::get('/courses','WelcomeController@clientIndex')->name('courses.clientIndex');
Route::get('/courses/{course_slug}','WelcomeController@show')->name('courses.clientShow');
